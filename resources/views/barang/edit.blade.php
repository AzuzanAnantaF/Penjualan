            ...
            <form action="{{route('barang.update', $b->id)}}" method="POST">
                ...
                <div class="col-lg-6">
                   <div class="form-group">
                      ...
                      <input type="text" name="harga" id="nama" value="{{ $b->harga }}" class="form-control @error('harga') is-invalid @enderror">
                      @error('harga')
                       <div class="text-danger">
                        {{ $message }}
                       </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="suplier_id" id="suplier_id" class="form-control @error('suplier_id') is-invalid @enderror">
                            ...
                            @foreach ($suplier as $s)
                             <option value="{{ $b->suplier_id }}">{{$s->nama}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select name="kategori_id" id="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
                            <option value="{{$b->kategori_id}}" selected>{{$b->suplier->nama}}</option>
